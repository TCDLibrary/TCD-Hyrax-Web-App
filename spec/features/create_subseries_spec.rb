...
RSpec.feature 'Create a Subseries', js: true do
  context 'a logged in user' do
    ...
    scenario do
      ...
      choose "payload_concern", option: "Subseries"
      click_button "Create work"

      # JL: Try to fix random rspec spec failures
      sleep 3

      expect(page).to have_content "Add New Subseries"
      ...
      # its element
      find('body').click
      choose('subseries_visibility_open')
      expect(page).to have_content('Please note, making something visible to the world (i.e. marking this as Public) may be viewed as publishing which could impact your ability to')
      check('agreement')

      click_on('Save')
      expect(page).to have_content('My Test Subseries')
