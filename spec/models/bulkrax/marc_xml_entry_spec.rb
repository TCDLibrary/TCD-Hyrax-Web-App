      ...
      context 'without a parent' do
        ...
        it 'builds entry using local_processing overrides and matchers' do
          ...
          expect(marc_xml_entry.parsed_metadata).to eq(
            ...
            'collection_title' => [],
            'collections' => [],
            'contributor' => ["Pollard, M. (Mary), Former owner", "Woods, Margaret W., active 1850, Former owner", "Pollard Collection, Former owner", "F. Houlston and Son, Printer"],
            'creator' => ["Sherwood, (Mary Martha), Mrs. 1775-1851, Author"],
            'creator_loc' => ["Sherwood, (Mary Martha), Mrs. 1775-1851, Author"],
            'creator_local' => [],
