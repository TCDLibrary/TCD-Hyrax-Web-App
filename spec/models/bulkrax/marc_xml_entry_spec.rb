      ...
      context 'without a parent' do
        ...
        it 'builds entry using local_processing overrides and matchers' do
          ...
          expect(marc_xml_entry.parsed_metadata).to eq(
            ...
            'collections' => [],
            'contributor' => ["Pollard, M. Former owner", "Woods, Margaret W., Former owner", "Pollard Collection, Former owner", "F. Houlston and Son, Printer"],
            'creator' => ["Sherwood, (Mary Martha), Mrs. 1775-1851, Author"],
            'creator_loc' => ["Bank of America, Sponsor"],
            ...
            'file' => [],
            'finding_aid' => ['More for archival/MSS collections, but map anyway'],
            'folder_number' => ['901'],
            ...
            'series_title' => ["Miss Primroses Library for Young Ladies ; number 6"],
            'source' => ["Jmarc0713"],
            'sponsor' => ["Digitisation and metadata creation sponsored by the Bank of America, 2018.", "TCD"],
            'subject' => ["Sherwood, Mrs. (Mary Martha), 1775-1851.", "F. Houlston and Son.", "Sherwood family."],
