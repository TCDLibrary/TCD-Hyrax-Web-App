...
module Hyrax
  module Forms
    ...
    class WorkForm
      ...
      self.terms = [:title, :creator, :contributor, :source, :identifier, :subject,
                    :language, :publisher, :date_created, :description,
                    :keyword, :license, :rights_statement, :representative_id,
                    :thumbnail_id, :rendering_ids, :related_url, :based_near,
                    :files,
                    :visibility_during_embargo, :embargo_release_date, :visibility_after_embargo,
                    :visibility_during_lease, :lease_expiration_date, :visibility_after_lease,
